...
import { updateUserSuccess,updateUserFailure,updateUserStart, deleteUserFailure, deleteUserStart, deleteUserSuccess, signOutUserStart, signOutUserFailure, signOutUserSuccess } from '../redux/user/userSlice.js';
  ...
  } catch (error) 
  {
    ...
    return (
      <div className='p-3 max-w-lg mx-auto '>
        ...
        <p className='text-sm text-green-700 mt-5'>{updateSuccess?'Successfully Updated':''}</p>
        ...
        {userListings.map((listing)=>(
          <div key={listing._id} className='border border-fuchsia-950 rounded-lg p-3 flex justify-between items-center gap-4'>
